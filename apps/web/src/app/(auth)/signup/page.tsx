      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800/50 rounded-2xl p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-zinc-500 mt-1">Start returning smarter in seconds</p>
          </div>
          ...
          <form className="space-y-4">
            ...
            <p className="text-[11px] text-zinc-600">
              ...
              <a href="#" className="text-zinc-400 hover:text-zinc-300">Terms of Service</a> and{" "}
